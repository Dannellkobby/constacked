...
// in constacked/test/helpers/test_helpers.dart.
...
import 'package:constacked/models/contact.dart' as _i8;
import 'package:constacked/services/contacts_service.dart' as _i7;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockContactsService extends _i1.Mock implements _i7.ContactsService {
  @override
  List<_i8.Contact> get contacts => (super.noSuchMethod(
        Invocation.getter(#contacts),
        returnValue: <_i8.Contact>[],
        returnValueForMissingStub: <_i8.Contact>[],
      ) as List<_i8.Contact>);
  ...
  @override
  _i5.Future<void> generateInitialContacts(int? count) => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  void sortContactsAtoZ() => super.noSuchMethod(
        Invocation.method(
          #sortContactsAtoZ,
          [],
        ),
  ...
  @override
  void addContact(_i8.Contact? contact) => super.noSuchMethod(
        Invocation.method(
          #addContact,
          [contact],
        ),
  ...
  @override
  List<_i8.Contact> generateRandomContacts(int? count) => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  void updateContact(_i8.Contact? contact) => super.noSuchMethod(
        Invocation.method(
          #updateContact,
          [contact],
        ),
  ...
  @override
  void deleteContact(String? selectedContactId) => super.noSuchMethod(
        Invocation.method(
          #deleteContact,
          [selectedContactId],
        ),
